      ...
      <div className='animate-text grid grid-cols-1 place-items-center w-auto h-screen p-4 lg:grid-cols-1'>
        <div className='w-full h-screen grid place-items-center m-0 lg:grid-cols-2'>
          <div className=''>
            ...
            <p className='text-sm text-center font-montserrat text-white'>Graduando em ciência da computação e formando em fullstack developer pela trybe, contendo 1 ano de experiência com desenvolvimento de softwares responsivos, escaláveis e com alto desempenho</p>
