...
function Mobile() {
  ...
  <div className='flex flex-col items-start lg:scale-150 md:scale-120'>
    <h1 className="animate-typingMobile lg:animate-typing md:animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white text-smp font-semibold text-white font-sans">PRAZER, ME CHAMO WESLEY RENAM E SOU</h1>
      ...
      <div className='text-xs ml-auto mt-2 flex justify-end font-semibold text-right font-montserrat text-white font-sans w-72 lg:flex lg:w-96 lg:justify-end md:flex'>
         <h1 className="link-underline link-underline-black font-bold text-end text-xs text-white ">TENHO 21 ANOS, GRADUANDO CIÊNCIA DA COMPUTAÇÃO E COM 1 ANO DE EXPERIÊNCIA COM PROJETOS PESSOAIS NA TRYBE. </h1>
      </div>
    </div>
