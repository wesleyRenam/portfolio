...
function Mobile() {
  return (
  <div className='flex flex-col w-auto h-screen justify-center items-center p-4 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black'>
    ...
    <h1 className="animate-typingMobile lg:animate-typing md:animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white text-smp font-semibold font-roboto text-white font-sans">PRAZER, ME CHAMO WESLEY RENAM E SOU</h1>
      <div className='flex items-center'>
        ...
        <a href="https://www.linkedin.com/in/wesleyrenam/" target="_blank"  rel="noreferrer">
          <img src={linkedinIcon} alt='linkedinIcon' className='w-8 lg:w-20 ml-4 mt-5 hover:scale-125 ease-in-out duration-300'/>
        </a>
        <a href="https://github.com/wesleyRenam" target="_blank"  rel="noreferrer">
          <img src={githubIcon} alt='githubIcon' className='w-8 lg:w-20 ml-4 mt-5 hover:scale-125 ease-in-out duration-300'/>
        </a>
        <a href={require('../cv.pdf')} target="_blank"  rel="noreferrer">
          <img src={cvIcon} alt='cvIcon' className='w-6 lg:w-16 ml-4 mt-5 hover:scale-125 ease-in-out duration-300'/>
        </a>
      </div>
